...
promedio_por_dominio <- function(var_dominio, var_promedio){
viviendas %>%
  ...
  summarise(
    ingreso_medio = Est.Mean.NHT(.[[var_promedio]], PIK_US, max(N_clase)),
...
ingreso_medio <- promedio_por_dominio("uno", "ingresoh")
ingreso_medio_hog10 <- ingreso_medio_por_dominio("hog10", "ingresoh")
ingreso_medio_clase <- ingreso_medio_por_dominio("clase", "ingresoh")
```
